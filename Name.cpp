...
void tag_Name::Init()
{
	...
	Tex[2] = Texture.SetLoadFile("Accet/Texture/End_Bg.jpg", 4250, 3000);
	...
	ChangeTime = Colision.Collsion_Info().Time_Save[0] + Colision.Collsion_Info().Time_Save[1] + Colision.Collsion_Info().Time_Save[2];
	Texture.Load(hWnd);
...
void tag_Name::Update()
{
...

	{
		...
		{
			if (Keyboard.IsPress(DIK_Q) && turm < 0)
			{
				turm = 10;
				Name[0] = 1;
			}
	...
	}
	{
		if (Name[0] == 0 && Name[1] == 0 && Name[2] == 0 && Name[3] == 0 && Name[4] == 0)
		{
			if (Keyboard.IsPress(DIK_W) && turm < 0)
			{
				turm = 10;
				Name[0] = 2;
			}
	...
	}
	{
		if (Name[0] == 0 && Name[1] == 0 && Name[2] == 0 && Name[3] == 0 && Name[4] == 0)
		{
			if (Keyboard.IsPress(DIK_E) && turm < 0)
			{
				turm = 10;
				Name[0] = 3;
			}
	...
	}
	{
		if (Name[0] == 0 && Name[1] == 0 && Name[2] == 0 && Name[3] == 0 && Name[4] == 0)
		{
			if (Keyboard.IsPress(DIK_R) && turm < 0)
			{
				turm = 10;
				Name[0] = 4;
			}
...
;
	...
	}
	{
		if (Name[0] == 0 && Name[1] == 0 && Name[2] == 0 && Name[3] == 0 && Name[4] == 0)
		{
			if (Keyboard.IsPress(DIK_T) && turm < 0)
			{
				turm = 10;
				Name[0] = 5;
			}
...
;
	...
	}
	{
		if (Name[0] == 0 && Name[1] == 0 && Name[2] == 0 && Name[3] == 0 && Name[4] == 0)
		{
			if (Keyboard.IsPress(DIK_Y) && turm < 0)
			{
				turm = 10;
				Name[0] = 6;
			}
	...
	}
	{
		if (Name[0] == 0 && Name[1] == 0 && Name[2] == 0 && Name[3] == 0 && Name[4] == 0)
		{
			if (Keyboard.IsPress(DIK_U) && turm < 0)
			{
				turm = 10;
				Name[0] = 7;
			}
...
;
	...
	}
	{
		if (Name[0] == 0 && Name[1] == 0 && Name[2] == 0 && Name[3] == 0 && Name[4] == 0)
		{
			if (Keyboard.IsPress(DIK_I) && turm < 0)
			{
				turm = 10;
				Name[0] = 8;
			}
...
;
	...
	}
	{
		if (Name[0] == 0 && Name[1] == 0 && Name[2] == 0 && Name[3] == 0 && Name[4] == 0)
		{
			if (Keyboard.IsPress(DIK_O) && turm < 0)
			{
				turm = 10;
				Name[0] = 9;
			}
	...
	}
	{
		if (Name[0] == 0 && Name[1] == 0 && Name[2] == 0 && Name[3] == 0 && Name[4] == 0)
		{
			if (Keyboard.IsPress(DIK_P) && turm < 0)
			{
				turm = 10;
				Name[0] = 10;
			}
	...
	}
	{
		if (Name[0] == 0 && Name[1] == 0 && Name[2] == 0 && Name[3] == 0 && Name[4] == 0)
		{
			if (Keyboard.IsPress(DIK_A) && turm < 0)
			{
				turm = 10;
				Name[0] = 11
;
	...
	}
	{
		if (Name[0] == 0 && Name[1] == 0 && Name[2] == 0 && Name[3] == 0 && Name[4] == 0)
		{
			if (Keyboard.IsPress(DIK_S) && turm < 0)
			{
				turm = 10;
				Name[0] = 12;
			}
	...
	}
	{
		if (Name[0] == 0 && Name[1] == 0 && Name[2] == 0 && Name[3] == 0 && Name[4] == 0)
		{
			if (Keyboard.IsPress(DIK_D) && turm < 0)
			{
				turm = 10;
				Name[0] = 13;
			}
...

	{
		if (Name[0] == 0 && Name[1] == 0 && Name[2] == 0 && Name[3] == 0 && Name[4] == 0)
		{
			if (Keyboard.IsPress(DIK_F) && turm < 0)
			{
				turm = 10;
				Name[0] = 14;
			}
...
;
	...
	}
	{
		if (Name[0] == 0 && Name[1] == 0 && Name[2] == 0 && Name[3] == 0 && Name[4] == 0)
		{
			if (Keyboard.IsPress(DIK_G) && turm < 0)
			{
				turm = 10;
				Name[0] = 15;
			}
...

	{
		if (Name[0] == 0 && Name[1] == 0 && Name[2] == 0 && Name[3] == 0 && Name[4] == 0)
		{
			if (Keyboard.IsPress(DIK_H) && turm < 0)
			{
				turm = 10;
				Name[0] = 16;
			}
	...
	}
	{
		if (Name[0] == 0 && Name[1] == 0 && Name[2] == 0 && Name[3] == 0 && Name[4] == 0)
		{
			if (Keyboard.IsPress(DIK_J) && turm < 0)
			{
				turm = 10;
				Name[0] =17;
			}
	...
	}
	{
		if (Name[0] == 0 && Name[1] == 0 && Name[2] == 0 && Name[3] == 0 && Name[4] == 0)
		{
			if (Keyboard.IsPress(DIK_K) && turm < 0)
			{
				turm = 10;
				Name[0] = 18;
			}
...

	{
		if (Name[0] == 0 && Name[1] == 0 && Name[2] == 0 && Name[3] == 0 && Name[4] == 0)
		{
			if (Keyboard.IsPress(DIK_L) && turm < 0)
			{
				turm = 10;
				Name[0] = 19;
			}
...

	{
		if (Name[0] == 0 && Name[1] == 0 && Name[2] == 0 && Name[3] == 0 && Name[4] == 0)
		{
			if (Keyboard.IsPress(DIK_Z) && turm < 0)
			{
				turm = 10;
				Name[0] = 20;
			}
...

	{
		if (Name[0] == 0 && Name[1] == 0 && Name[2] == 0 && Name[3] == 0 && Name[4] == 0)
		{
			if (Keyboard.IsPress(DIK_X) && turm < 0)
			{
				turm = 10;
				Name[0] = 21;
			}
...

	{
		if (Name[0] == 0 && Name[1] == 0 && Name[2] == 0 && Name[3] == 0 && Name[4] == 0)
		{
			if (Keyboard.IsPress(DIK_C) && turm < 0)
			{
				turm = 10;
				Name[0] = 22;
			}
...

	{
		if (Name[0] == 0 && Name[1] == 0 && Name[2] == 0 && Name[3] == 0 && Name[4] == 0)
		{
			if (Keyboard.IsPress(DIK_V) && turm < 0)
			{
				turm = 10;
				Name[0] = 23;
			}
...

	{
		if (Name[0] == 0 && Name[1] == 0 && Name[2] == 0 && Name[3] == 0 && Name[4] == 0)
		{
			if (Keyboard.IsPress(DIK_B) && turm < 0)
			{
				turm = 10;
				Name[0] = 24;
			}
	...
	}
	{
		if (Name[0] == 0 && Name[1] == 0 && Name[2] == 0 && Name[3] == 0 && Name[4] == 0)
		{
			if (Keyboard.IsPress(DIK_N) && turm < 0)
			{
				turm = 10;
				Name[0] = 25;
			}
...

	{
		if (Name[0] == 0 && Name[1] == 0 && Name[2] == 0 && Name[3] == 0 && Name[4] == 0)
		{
			if (Keyboard.IsPress(DIK_M) && turm < 0)
			{
				turm = 10;
				Name[0] = 26;
			}
	...
	if (Fade_Counter)
	{
		...
		{
			Sound.Stop();
			Scene.SetNextScene(SCENE_HIGHSCORE);
		}
	}
}
void tag_Name::Draw()
{
	...
	Sprite.Draw_Tex_x_y(Tex[2], 1260, 850, 1, 1, 1);
	Sprite.Draw_Tex_x_y(Tex[0], 1040 ,300, 1,1, 1);
	Sprite.Draw_Tex_x_y(Tex[1], 960, 550, 1, 1, 1);
	for (int g = 0; g < 27; g++)
	{
		for (int i = 0; i < 5; i++)
		{
			if (Name[i] == g+1)
			{
				Sprite.Draw_Tex_x_y(N_Tex[g], 520.0f + (110.0f * i), 530.0f, 1.0f, 1.0f, 1.0f);
			}
		}
	}
